...
//                 <p>
//                   Sweftfly Inc provides custom software application development
//                   services to clients across the globe to help organizations
//                   achieve their mission-critical goals. Off-the-shelf products
//                   seldom meet client needs completely, and working with Sweftfly Inc
...
//                 <p>
//                   Choosing the right technology is key to future growth. Sweftfly Inc
...
//               <div className="cp-text-block cp-text-block--two">
//                 <p>
//                   Sweftfly Inc key strength lies in identifying and deploying
...
//             <div className="cp-text-stack">
//               <div className="cp-text-block cp-text-block--one">
//                 <p>Sweftfly Inc provides custom software application development services to clients across the globe to help organizations achieve their mission-critical goals. Off-the-shelf products seldom meet client needs completely, and working with Sweftfly Inc allows clients to create their own solutions in a cost-effective and efficient way.</p>
//               </div>
//               <div className="cp-text-block cp-text-block--two">
//                 <p>Choosing the right technology is key to future growth. Sweftfly Inc provides tailored solutions that leverage existing systems or introduce modern technologies to support each client's business goals.</p>
//               </div>
//             </div>
//           </div>
//         </section>
...
//                 <p>Sweftfly Inc key strength lies in identifying and deploying <strong>flexible resources</strong> who can support clients during their expansion and growth phase — so we can reduce and optimize the cost of engagement without compromising quality.</p>
//               </div>
//             </div>
//           </div>
//         </section>
...
//             <div className="cp-text-stack">
//               <div className="cp-text-block cp-text-block--one">
//                 <p>Technology moves fast, and staying current is what keeps careers moving. Sweftfly Inc training programs are built by senior engineers who've shipped real products — not just classroom theory.</p>
//               </div>
//               <div className="cp-text-block cp-text-block--two">
...
//               </div>
//               <div className="cp-text-block cp-text-block--two">
//                 <p>Sweftfly Inc <strong>Job Support</strong> connects you with senior engineers who've solved your exact problem before — across every major stack, cloud, and framework.</p>
//               </div>
//               <div className="cp-text-block cp-text-block--one">
...
//               </div>
//               <div className="cp-text-block cp-text-block--two">
//                 <p>Sweftfly Inc provides <strong>end-to-end H1B petition support</strong> — from initial strategy and documentation to filing, RFE responses, transfers, and extensions.</p>
//               </div>
//               <div className="cp-text-block cp-text-block--one">
...
//               <div className="cp-text-block cp-text-block--one">
//                 <p>
//                   Sweftfly Inc provides both <strong>online and offline
...
//             <div className="cp-text-stack">
//               <div className="cp-text-block cp-text-block--one">
//                 <p>SweftFly Inc. delivers specialized IT staffing and technology talent solutions to organizations across the United States, helping businesses access qualified professionals to support critical technology initiatives. From software engineering and cloud to data, AI, cybersecurity, and DevOps, we connect organizations with skilled technology professionals whose experience aligns with their technical requirements and business needs.
// </p>
//               </div>
//               <div className="cp-text-block cp-text-block--two">
//                 <p>We combine technical expertise, industry knowledge, and flexible staffing models to help organizations build and strengthen technology teams, fill critical roles, scale project capabilities, and access specialized talent efficiently. Our solutions include Contract Staffing, Contract-to-Hire, Direct Placement, and Project-Based Resource Augmentation.</p>
//               </div>
//             </div>
//           </div>
//         </section>
...
//             <div className="cp-text-stack">
//               <div className="cp-text-block cp-text-block--one">
//                 <p>SweftFly Inc delivers specialized IT staffing and workforce solutions that help businesses build high-performing technology teams, accelerate critical initiatives, and scale technical capabilities. We connect companies with professionals in Software Engineering, Cloud & DevOps, Data & AI, Cybersecurity, QA & Automation, Enterprise Applications, IT Infrastructure, and emerging technologies.</p>
//               </div>
//               <div className="cp-text-block cp-text-block--two">
//                 <p>Our approach goes beyond resume sourcing. We combine talent intelligence, technical screening, experience validation, and role-specific assessment to identify professionals aligned with your technology stack, project requirements, delivery model, and business environment. This enables our clients to reduce hiring cycles, access quality talent, and build high-performing teams with greater confidence.</p>
//               </div>
//               {/* <div className="cp-text-block cp-text-block--one">
//                 <p>We do not just collect and deliver CVs — we thoroughly screen the profiles and our experts talk to the candidates to understand whether they fit the requirement. Once we are confident, only then do we share the CVs with our client so that our client can save their time and cost.</p>
//                 <p>Sweftfly Inc key strength lies in identifying and deploying <strong>flexible resources</strong> who can support clients during their expansion and growth phase — so we can reduce and optimize the cost of engagement without compromising quality.</p>
...
//             <div className="cp-text-stack">
//               <div className="cp-text-block cp-text-block--one">
//                 <p>Sweftfly Inc provides both <strong>online and offline training</strong> for all software technologies. Our team of experts has deep, hands-on experience teaching the technologies that enterprises actually use — not just textbook theory.</p>
//               </div>
//               <div className="cp-text-block cp-text-block--two">
...
const STAFFING_MODELS = [
  { num: '01', title: 'Contract Staffing', text: 'Flexible access to skilled IT professionals for short-term, long-term, or project-based requirements.', icon: '🎯' },
  { num: '02', title: 'Contract-to-Hire', text: 'Evaluate technical expertise and role fit before transitioning a resource into a permanent position.', icon: '🔄' },
  { num: '03', title: 'Direct Hire', text: 'End-to-end recruitment for permanent technology roles across specialized skill domains.', icon: '🧩' },
  { num: '04', title: 'IT Staff Augmentation', text: 'Quickly strengthen existing teams with specialized technical professionals aligned to your technology stack.', icon: '📈' },
  { num: '05', title: 'Project-Based Staffing', text: 'Dedicated technical resources or teams aligned with defined project scope, timelines, and delivery objectives.', icon: '🛡️' },
  { num: '06', title: 'Managed Resource Solutions', text: 'Flexible technology teams managed around specific business requirements, providing scalable expertise and delivery support.', icon: '🤝' },
];
      ...
      <div className="cp-shell">
        ...
        <section className="cp-hero" ref={heroRef}>
          ...
          <div className={`cp-hero__right ${heroVisible ? 'is-visible' : ''}`}>
            <div className="cp-text-stack">
              <div className="cp-text-block cp-text-block--one">
                <p>SweftFly Inc provides technology training and talent development designed to strengthen our IT staffing capabilities. Our programs prepare professionals to meet US client requirements, project expectations, and evolving technology demands, helping create a stronger pool of skilled, job-ready talent.</p>
              </div>
              <div className="cp-text-block cp-text-block--two">
                <p> Our training covers Software Engineering, Cloud & DevOps, Data & AI, Cybersecurity, QA Automation, Enterprise Applications, and emerging technologies. Through practical, industry-focused learning, we help professionals enhance their technical capabilities while enabling SweftFly Inc to deliver better-aligned, project-ready IT talent to clients.</p>
              </div>
              <div className="cp-text-block cp-text-block--one">
                {/* <p>Small batches. Live mentors. Real projects. Interview preparation. We don't just teach — we help you get hired.</p> */}
              </div>
      ...
      <div className="cp-shell">
        ...
        <section className="cp-hero" ref={heroRef}>
          ...
          <div className={`cp-hero__right ${heroVisible ? 'is-visible' : ''}`}>
            <div className="cp-text-stack">
              <div className="cp-text-block cp-text-block--one">
                <p>SweftFly Inc provides H-1B filing support for qualified technology professionals and employers seeking to navigate the US employment-based immigration process. We support the preparation and coordination of required documentation while helping ensure filings are organized and aligned with applicable requirements.</p>
              </div>
              <div className="cp-text-block cp-text-block--two">
                <p>Our support covers H-1B registration and petition documentation, case coordination, document preparation, status tracking, and communication support, helping employers and technology professionals manage the process with greater clarity and efficiency.</p>
              </div>
              <div className="cp-text-block cp-text-block--one">
                {/* <p>We coordinate with your employer and legal team, keep every deadline on track, and stay with you through approval and beyond.</p> */}
              </div>
